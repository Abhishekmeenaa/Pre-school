...
// import {
//   FaSmile, FaBookOpen, FaChartLine, FaComments, FaBrain, FaLanguage,
//   FaChalkboardTeacher, FaClock, FaUsers, FaAward, FaGraduationCap
// } from 'react-icons/fa';
...
//             <h3 className="text-xl font-semibold text-gray-800 mb-6" data-aos="fade-right">
//               Here's what your child could miss without early schooling:
//             </h3>

//             <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
//               {[
//                 { icon: <FaSmile className="text-3xl" />, text: "Improved social skills" },
//                 { icon: <FaBookOpen className="text-3xl" />, text: "No need for special education instruction" },
//                 { icon: <FaChartLine className="text-3xl" />, text: "Better marks and enhanced attention spans" },
//                 { icon: <FaComments className="text-3xl" />, text: "Fewer behavioral problems" },
//                 { icon: <FaBrain className="text-3xl" />, text: "Development milestones achieved" },
//                 { icon: <FaLanguage className="text-3xl" />, text: "Better language development" }
//               ].map((item, index) => (
//                 <div 
//                   key={index}
//                   data-aos="fade-up"
...
//                 >
//                   <div className="bg-[#EE2341]/10 p-3 rounded-full text-[#EE2341]">
//                     {item.icon}
//                   </div>
...
//               {[
//                 { icon: <FaChalkboardTeacher className="text-4xl" />, text: "Certified and trained teachers" },
//                 { icon: <FaClock className="text-4xl" />, text: "23+ Years of experience" },
//                 { icon: <FaUsers className="text-4xl" />, text: "7 lakh+ students nurtured" },
//                 { icon: <FaBookOpen className="text-4xl" />, text: "35,000+ hours curriculum research" },
//                 { icon: <FaAward className="text-4xl" />, text: "60+ awards" },
//                 { icon: <FaGraduationCap className="text-4xl" />, text: "6 lakh+ hours of partner training" }
//               ].map((item, index) => (
//                 <div 
//                   key={index}
//                   data-aos="zoom-in-up"

...
import { FaChalkboardTeacher, FaChild, FaUsers, FaMapMarkerAlt, FaGraduationCap, FaHandsHelping } from 'react-icons/fa';
...
const Careers = () => {
  ...
  const positions = [
    {
      ...
      description: "Lead classroom activities and create engaging learning experiences for children aged 2-6 years."
    },
    {
      id: 2,
      title: "Assistant Teacher",
      branches: "Multiple branches available",
      description: "Support lead teachers in implementing our curriculum and caring for young learners."
    },
    {
      id: 3,
      title: "Center Head",
    ...
    },
    {
      ...
      branches: "Multiple branches available",
      description: "Assist in daily activities and provide nurturing care to children."
    }
  ];
  ...
  const cities = [
    "Bhopal", "Indore", "Raipur", "New Delhi", "Bombay",
    "Bangalore", "Jaipur", "Chennai", "Agra", "Dehradun",
    "Shimla", "Mysore", "Cochin"
  ];
      ...
      <div className="relative h-96 w-full">
        ...
        <div className="absolute inset-0 bg-black/40 flex items-center justify-center">
          <div className="text-center">
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-4">Careers at BunnyTots</h1>
            <p className="text-xl text-white max-w-2xl mx-auto">Shape Young Minds, Build Bright Futures</p>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="text-center mb-16">
            <p className="text-lg text-gray-600 max-w-4xl mx-auto">
              At BunnyTots, we're on a mission to nurture the early years of childhood through love, learning, and innovation.
              With multiple branches across the country, we are always looking for dedicated educators and support staff to join our passionate team.
            </p>
            <p className="text-lg text-gray-600 max-w-4xl mx-auto mt-4">
              Whether you're an experienced teacher or just beginning your journey in early childhood education,
              you'll find a nurturing environment and opportunities to grow with us.
            </p>
          </div>

         <div className="p-6 max-w-4xl mx-auto">
  <h2 className="text-3xl text-center md:text-4xl font-bold text-[#00008B] mb-8">
    Preschool Teacher <span className="text-[#E91E63]">Selection Criteria</span> Framework
  </h2>
  ...
  <div className="space-y-4 bg-white rounded-lg p-6 shadow-sm">
    <div className="border-l-4 border-blue-500 pl-4 py-2 hover:bg-blue-50 transition-colors">
      <h3 className="font-semibold text-lg text-gray-800">1. Personal Traits & Disposition (Soft Skills)</h3>
    </div>

    <div className="border-l-4 border-pink-500 pl-4 py-2 hover:bg-pink-50 transition-colors">
      <h3 className="font-semibold text-lg text-gray-800">2. Communication Skills</h3>
    </div>

    <div className="border-l-4 border-purple-500 pl-4 py-2 hover:bg-purple-50 transition-colors">
      <h3 className="font-semibold text-lg text-gray-800">3. Teaching Skills & Child Development Knowledge</h3>
    </div>

    <div className="border-l-4 border-green-500 pl-4 py-2 hover:bg-green-50 transition-colors">
      <h3 className="font-semibold text-lg text-gray-800">4. Professionalism & Ethics</h3>
    </div>

    <div className="border-l-4 border-orange-500 pl-4 py-2 hover:bg-orange-50 transition-colors">
      <h3 className="font-semibold text-lg text-gray-800">5. Qualifications & Experience</h3>
    </div>
  </div>
</div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-2  lg:grid-cols-4 gap-8 mb-14">
            {perks.map((perk, index) => (
              <div key={index} className="bg-white p-8 rounded-xl shadow-md hover:shadow-lg transition-shadow border border-gray-100">
                ...
                <h3 className="md:text-xl  text-sm font-bold text-center mb-3">{perk.title}</h3>
                <p className="text-gray-600 text-[12px] text-center items-center ">{perk.description}</p>
              </div>
            ))}
          </div>
          ...
          <div className="bg-white rounded-2xl p-8 md:p-12 mb-">
            <div className="text-center mb-8">
              <h2 className="text-2xl md:text-3xl font-bold text-[#00008B] mb-2">Available Positions (Multiple Branches)</h2>
              <p className="text-gray-600"> Applicants must be polite and passionate about working with young children and committed to continuous  improvement
                .</p>
            </div>

            <form className="max-w-5xl md:max-w-3xl  mx-auto border border-[#00008B] rounded-2xl p-6 md:p-8" onSubmit={handleSubmit}>
              <div className=" grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  <label className="block text-gray-700 mb-2" htmlFor="position">Position Applying For:</label>
                  <select
                    id="position"
                ...
                <div>
                  <label className="block text-gray-700 mb-2" htmlFor="city">Preferred City:</label>
                  <select
                    id="city"
                    value={formData.city}
                    onChange={handleChange}
                ...
                <div>
                  <label className="block text-gray-700 mb-2" htmlFor="location">Preferred Location:</label>
                  <input
                    type="text"
                    id="location"
                ...
                <div>
                  <label className="block text-gray-700 mb-2" htmlFor="experience">Total Experience (in years):</label>
                  <input
                    type="number"
                    id="experience"
                ...
                <div>
                  <label className="block text-gray-700 mb-2" htmlFor="qualification">Highest Qualification:</label>
                  <input
                    type="text"
                    id="qualification"
              ...
              <div className="mt-6">
                <label className="block text-gray-700 mb-2" htmlFor="resume">Upload Your Resume (PDF/DOC):</label>
                <input
                  type="file"
                  id="resume"
          ...
          <div className="text-center bg-white p-8 rounded-2xl shadow-md border border-gray-100">
            <h2 className="text-2xl md:text-3xl font-bold text-[#00008B] mb-4">Contact Us</h2>

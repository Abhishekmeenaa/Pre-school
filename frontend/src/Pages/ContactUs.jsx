      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Have questions about our programs or franchise opportunities? We're here to help!
          </p>
        </div>
          ...
          <div className="relative group">
            ...
            <div className="relative bg-white rounded-2xl overflow-hidden shadow-xl border border-gray-100 p-8">
              ...
              <form className="space-y-6">
                ...
                <button
                  type="submit"
                  className="w-full px-6 py-5 bg-gradient-to-r from-[#0f172a] to-[#1e3a8a]
 text-white font-medium rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-[1.02]"
                >
                  Send Message
                </button>
              </form>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">support@bunnytots.example.com</p>
                  </div>
                </div>

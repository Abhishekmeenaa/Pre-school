...
const SyllabusForm = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    console.log("Form Data:", formData); // Just logging the data
    alert("Form data collected successfully (check console)");
    setFormData({ classes: "", subject: "", syllabus: "", documents: [] });
  };
    ...
    <div className="relative bg-white py-16 px-4 sm:px-6 lg:px-8 overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8">
          ...
          <div className="mb-8">
            <label className="block text-gray-700 font-medium mb-2">Documents (optional)</label>
            <input
              type="file"
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#EE2341] focus:border-transparent"
              name="documents"
